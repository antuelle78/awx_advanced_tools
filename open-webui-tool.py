...
class PromptOptimizer:
    ...
    def _load_tool_prompts(self) -> Dict[str, str]:
        ...
        return {
            "list_templates": "Think step by step: 1. Understand the request for job templates. 2. Call list_templates to get available options. 3. Use the results to inform further actions. Example: Call this to find template IDs for launching jobs.",
            ...
            "list_inventories": "Think step by step: 1. List inventories to find IDs. 2. Use for other operations. 3. Ensure no duplicates. Example: Call this before creating.",
            ...
            "list_schedules": "Think step by step: 1. Get template_id. 2. Call list_schedules. 3. Review schedule details. Example: template_id=123.",
            "get_schedule": "Think step by step: 1. Get schedule_id from list_schedules. 2. Call get_schedule. 3. Check status. Example: schedule_id=101.",
            "create_schedule": "Think step by step: 1. Get template_id. 2. Define rrule. 3. Call create_schedule. Example: name='daily', rrule='FREQ=DAILY', job_template_id=123.",
            "toggle_schedule": "Think step by step: 1. Get schedule_id. 2. Decide enabled status. 3. Call toggle_schedule. Example: schedule_id=101, enabled=true.",
            "delete_schedule": "Think step by step: 1. Confirm deletion. 2. Call delete_schedule. 3. Verify removal. Example: schedule_id=101.",
            "list_organizations": "Think step by step: 1. List organizations for IDs. 2. Use for creating resources. 3. Ensure valid org. Example: Call this before creating inventory.",
            "get_organization": "Think step by step: 1. Get organization_id. 2. Call get_organization. 3. Use details. Example: organization_id=2.",
            "create_organization": "Think step by step: 1. Check if name exists. 2. Call create_organization. 3. Verify creation. Example: name='IT Team', description='Infrastructure team'.",
            "update_organization": "Think step by step: 1. Get organization_id. 2. Call update_organization. 3. Confirm changes. Example: organization_id=2, name='Updated IT'.",
            "delete_organization": "Think step by step: 1. Confirm deletion. 2. Call delete_organization. 3. Verify removal. Example: organization_id=2.",
            "list_projects": "Think step by step: 1. List projects for IDs. 2. Use for other operations. 3. Ensure no duplicates. Example: Call this before creating.",
            "get_project": "Think step by step: 1. Get project_id. 2. Call get_project. 3. Use details. Example: project_id=5.",
            "create_project": "Think step by step: 1. Check if name exists. 2. Call create_project. 3. Verify creation. Example: name='my-repo', scm_type='git', scm_url='https://github.com/user/repo.git'.",
            "update_project": "Think step by step: 1. Get project_id. 2. Call update_project. 3. Confirm changes. Example: project_id=5, name='updated-repo'.",
            "delete_project": "Think step by step: 1. Confirm deletion with confirm=true. 2. Use dry_run if testing. 3. Call delete_project. Example: project_id=5, confirm=true.",
            "sync_project": "Think step by step: 1. Get project_id. 2. Call sync_project. 3. Monitor the job. Example: project_id=5.",
            "list_credentials": "Think step by step: 1. List credentials for IDs. 2. Use for other operations. 3. Ensure no duplicates. Example: Call this before creating.",
            "get_credential": "Think step by step: 1. Get credential_id. 2. Call get_credential. 3. Use details. Example: credential_id=10.",
            "create_credential": "Think step by step: 1. Check if name exists. 2. Call create_credential. 3. Verify creation. Example: name='ssh-key', credential_type=1, inputs={'username': 'admin'}.",
            "update_credential": "Think step by step: 1. Get credential_id. 2. Call update_credential. 3. Confirm changes. Example: credential_id=10, name='updated-key'.",
            "delete_credential": "Think step by step: 1. Confirm deletion. 2. Call delete_credential. 3. Verify removal. Example: credential_id=10.",
            "list_users": "Think step by step: 1. List users for IDs. 2. Use for other operations. 3. Ensure no duplicates. Example: Call this before creating.",
            "get_user": "Think step by step: 1. Get user_id. 2. Call get_user. 3. Use details. Example: user_id=2.",
            ...
            "list_workflow_job_templates": "Think step by step: 1. List workflow templates for IDs. 2. Use for other operations. 3. Ensure no duplicates. Example: Call this before creating.",
            "get_workflow_job_template": "Think step by step: 1. Get workflow_job_template_id. 2. Call get_workflow_job_template. 3. Use details. Example: workflow_job_template_id=7.",
            "create_workflow_job_template": "Think step by step: 1. Check if name exists. 2. Call create_workflow_job_template. 3. Verify creation. Example: name='my-workflow', description='Automation workflow'.",
            "update_workflow_job_template": "Think step by step: 1. Get workflow_job_template_id. 2. Call update_workflow_job_template. 3. Confirm changes. Example: workflow_job_template_id=7, name='updated-workflow'.",
            "delete_workflow_job_template": "Think step by step: 1. Confirm deletion. 2. Call delete_workflow_job_template. 3. Verify removal. Example: workflow_job_template_id=7.",
            "launch_workflow_job_template": "Think step by step: 1. Get workflow_job_template_id. 2. Prepare extra_vars. 3. Call launch_workflow_job_template. Example: workflow_job_template_id=7, extra_vars={'env': 'prod'}.",
            "list_notifications": "Think step by step: 1. List notifications for IDs. 2. Use for other operations. 3. Ensure no duplicates. Example: Call this before creating.",
            "get_notification": "Think step by step: 1. Get notification_id. 2. Call get_notification. 3. Use details. Example: notification_id=8.",
            "create_notification": "Think step by step: 1. Check if name exists. 2. Call create_notification. 3. Verify creation. Example: name='email-alert', notification_type='email', notification_configuration={'email': 'admin@example.com'}.",
            "update_notification": "Think step by step: 1. Get notification_id. 2. Call update_notification. 3. Confirm changes. Example: notification_id=8, name='updated-alert'.",
            "delete_notification": "Think step by step: 1. Confirm deletion. 2. Call delete_notification. 3. Verify removal. Example: notification_id=8.",
            "list_instance_groups": "Think step by step: 1. List instance groups for IDs. 2. Use for other operations. 3. Ensure no duplicates. Example: Call this before creating.",
            "get_instance_group": "Think step by step: 1. Get instance_group_id. 2. Call get_instance_group. 3. Use details. Example: instance_group_id=9.",
            "create_instance_group": "Think step by step: 1. Check if name exists. 2. Call create_instance_group. 3. Verify creation. Example: name='prod-group'.",
            "update_instance_group": "Think step by step: 1. Get instance_group_id. 2. Call update_instance_group. 3. Confirm changes. Example: instance_group_id=9, name='updated-group'.",
            "delete_instance_group": "Think step by step: 1. Confirm deletion. 2. Call delete_instance_group. 3. Verify removal. Example: instance_group_id=9.",
            "list_activity_stream": "Think step by step: 1. List activity stream for events. 2. Use for monitoring. 3. Review recent actions. Example: page=1, page_size=20.",
        }

    def get_optimized_prompt(self, tool_name: str, **kwargs) -> str:
        """Generate an optimized prompt for a specific tool with ReAct-like structure."""
        ...
        reasoning = f"Thought: {base_prompt} Action: Call {tool_name} with appropriate parameters. Observation: Wait for response and act accordingly."
