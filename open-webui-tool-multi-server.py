...
class Tools:
    class Valves(BaseModel):
        ...
        enable_model_optimization: bool = Field(
            default=True, description="Enable model-aware optimizations"
        )
        ...
        try:
            if method == "GET":
                ...
                response = self.client.post(
                    url, headers=self._get_headers(), json=json_data, params=params
                )
            elif method == "PATCH":
    ...
    def create_inventory(
        ...
        return self._make_request(
            "create_inventory", "/inventories", method="POST", json_data=json_data
        )
    ...
    def sync_inventory(self, inventory_id: int) -> str:
        ...
        return self._make_request(
            "sync_inventory", f"/inventories/{inventory_id}/sync", method="POST"
        )

    def delete_inventory(self, inventory_id: int) -> str:
        """Deletes an inventory from AWX."""
        return self._make_request(
            "delete_inventory", f"/inventories/{inventory_id}", method="DELETE"
        )
    ...
    def create_host(self, host_data: Dict[str, Any]) -> str:
        ...
        return self._make_request(
            "create_host", "/hosts/", method="POST", json_data=host_data
        )
    ...
    def create_user(
        ...
        return self._make_request(
            "create_user", "/users", method="POST", json_data=json_data
        )
    ...
    def update_user(
        ...
        if email:
            json_data["email"] = email
        return self._make_request(
            "update_user", f"/users/{user_id}", method="PATCH", json_data=json_data
        )
    ...
    def create_project(
        ...
        if description:
            json_data["description"] = description
        return self._make_request(
            "create_project", "/projects", method="POST", json_data=json_data
        )
    ...
    def sync_project(self, project_id: int) -> str:
        ...
        return self._make_request(
            "sync_project", f"/projects/{project_id}/sync", method="POST"
        )

    def delete_project(self, project_id: int) -> str:
        """Deletes a project from AWX."""
        return self._make_request(
            "delete_project", f"/projects/{project_id}", method="DELETE"
        )
    ...
    def get_organization(self, organization_id: int) -> str:
        ...
        return self._make_request(
            "get_organization", f"/organizations/{organization_id}"
        )
    ...
    def create_organization(self, name: str, description: Optional[str] = None) -> str:
        ...
        if description:
            json_data["description"] = description
        return self._make_request(
            "create_organization", "/organizations", method="POST", json_data=json_data
        )
    ...
    def delete_organization(self, organization_id: int) -> str:
        ...
        return self._make_request(
            "delete_organization", f"/organizations/{organization_id}", method="DELETE"
        )
    ...
    def list_schedules(self, template_id: int) -> str:
        ...
        return self._make_request(
            "list_schedules", f"/job_templates/{template_id}/schedules"
        )
    ...
    def delete_schedule(self, schedule_id: int) -> str:
        ...
        return self._make_request(
            "delete_schedule", f"/schedules/{schedule_id}", method="DELETE"
        )
    ...
    def create_credential(
        self, name: str, credential_type: str, inputs: Dict[str, Any]
    ) -> str:
    ...
    def delete_credential(self, credential_id: int) -> str:
        ...
        return self._make_request(
            "delete_credential", f"/credentials/{credential_id}", method="DELETE"
        )

    def list_workflow_job_templates(self) -> str:
        """Lists all workflow job templates in AWX."""
        return self._make_request(
            "list_workflow_job_templates", "/workflow_job_templates"
        )
    ...
    def launch_workflow_job_template(
        self, workflow_id: int, extra_vars: Optional[Dict[str, Any]] = None
    ) -> str:
    ...
    def update_workflow_job_template(
        ...
        return self._make_request(
            ...
            f"/workflow_job_templates/{workflow_id}",
            method="PATCH",
            json_data=json_data,
        )
    ...
    def list_activity_stream(self, page: int = 1, page_size: int = 50) -> str:
        ...
        return self._make_request(
            "list_activity_stream", "/activity_stream", params=params
        )
